...
`最後に検知してからの経過秒数 + α > 監視間隔` を満たした場合だけSlack通知するように書けば良い。

SQLiteの簡単なCRUD操作を提供してくれるMojo::SQLiteというラッパーモジュールがあるので使うとよい。

 

Mojo::SQLite : [リンク](https://metacpan.org/pod/Mojo::SQLite)
